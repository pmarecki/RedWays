...
/**
 * Code by anta; from (C) http://codeforces.com/contest/514/standings
 * Need 3 hashes to avoid colissions.
 *
 * 1-based hash
...
public class SubstringHash {
    static int NMODS = 1;
    long[] MOD =  {1000_000_007L, 2147_483_647L};
    long[] BASE = {298_564_927L, 2147_484_007L};
    Hash[] powh, preh;
